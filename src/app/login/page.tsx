          ...
          <section className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
            <header className="text-center mb-6">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Conecte-se usando sua conta do GitHub para acessar nossa
                plataforma
              </p>
            </header>
            <div className="flex flex-col items-center">
              ...
              <p className="mt-4 text-xs text-center text-gray-500 px-6">
                Ao clicar acima, você será redirecionado para o GitHub para
                autorizar o acesso à sua conta. Não armazenamos sua senha do
                GitHub.
              </p>
            </div>
          </section>
